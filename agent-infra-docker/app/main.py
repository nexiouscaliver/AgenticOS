...
- Multi-format document parser (PDF, DOCX, CSV, XLSX, JSON, MD, TXT)
...
from agents.multi_format_parser import get_multi_format_parser
...
def get_optimized_agents(debug_mode: bool = False):
    ...
    multi_format_parser = get_multi_format_parser(
        model_id="gpt-4o",  # Premium model for document analysis
        debug_mode=debug_mode,
    )
