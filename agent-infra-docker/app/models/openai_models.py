...
def create_openai_model(
    model_id: str = "gpt-4o-mini", temperature: float = 0.7, max_tokens: Optional[int] = None, **kwargs
) -> OpenAIChat:
    """
    ...
    return OpenAIChat(
        id=model_id, api_key=api_key, temperature=config["temperature"], max_tokens=config["max_tokens"], **kwargs
    )
