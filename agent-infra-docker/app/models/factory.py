...
from .deepseek_models import create_deepseek_model, get_best_deepseek_model_for_task, get_deepseek_cost_per_token
from .glm_models import create_glm_model, get_best_glm_model_for_task, get_glm_cost_per_token
from .openai_models import create_openai_model, get_best_openai_model_for_task, get_openai_cost_per_token
...
class ModelFactory:
    ...
    TASK_MODEL_MAP = {
        TaskType.RESEARCH: {"budget": "deepseek-chat", "balanced": "gpt-4o-mini", "premium": "gemini-2.0-flash"},
        TaskType.CREATIVE: {"budget": "glm-4.5-air", "balanced": "gpt-4o-mini", "premium": "gpt-4o"},
        TaskType.ANALYSIS: {"budget": "deepseek-chat", "balanced": "glm-4.5-air", "premium": "gpt-4o"},
        TaskType.CODING: {"budget": "deepseek-coder", "balanced": "gpt-4o-mini", "premium": "gpt-4o"},
        TaskType.SIMPLE: {"budget": "deepseek-chat", "balanced": "glm-4.5-air", "premium": "gpt-4o-mini"},
        TaskType.COMPLEX: {"budget": "gpt-4o-mini", "balanced": "gpt-4o", "premium": "gemini-1.5-pro"},
        TaskType.MULTILINGUAL: {"budget": "glm-4.5-air", "balanced": "glm-4.5", "premium": "gpt-4o"},
        TaskType.FAST: {"budget": "glm-4.5-air", "balanced": "deepseek-chat", "premium": "gpt-4o-mini"},
    }

    @classmethod
    def create_model(self, model_id: str, provider: Optional[ModelProvider] = None, **kwargs) -> Model:
        """
    ...
    def get_optimal_model(
        self, task_type: Union[TaskType, str], priority: str = "balanced", max_cost_per_1k: Optional[float] = None
    ) -> str:
        """
    ...
    def _find_cheapest_model(self, max_cost: float) -> str:
        ...
        affordable_models = [(model_id, cost) for model_id, cost in self.MODEL_COSTS.items() if cost <= max_cost]
...
def get_optimal_model(
    task_type: Union[TaskType, str], priority: str = "balanced", max_cost_per_1k: Optional[float] = None, **kwargs
) -> Model:
    """
